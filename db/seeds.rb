...
Player.create!(team: uru, position: 'field', name: 'Diego Pérez')
...
Player.create!(team: uru, position: 'field', name: 'Egidio Arévalo Ríos')
...
Player.create!(team: uru, position: 'field', name: 'Christian Stuani')
...
Question.create!(
  ...
  body_pt: 'Quem será melhor terceiro jogador (troféu Bola de Bronze)?', played_at: '2014-06-12 17:00:00 -0300'.to_time, answer_type: 'player')
Question.create!(
